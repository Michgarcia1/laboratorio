      ...
      <div v-else>
        <q-inner-loading :showing="true" class="q-gutter-md">
          ...
          <div class="flex column items-center q-gutter-xs">
            <p style="font-size: 1.2rem; font-weight: bold;">Lo sentimos por el momento no tenemos servicios disponibles :(</p>
            <q-btn no-caps style="background: #096393; color: white"
